      ...
      <div className="relative pt-32 pb-10 md:pt-40 md:pb-16">
        <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
          ...
          <p
            ...
            data-aos-delay="200"
          >
            Conoce a nuestro equipo altamente motivado, creativo y comprometido,
            compuesto por profesionales talentosos que comparten una pasión por
            la tecnología y la excelencia en el servicio al cliente. Trabajamos
            juntos para superar desafíos y lograr nuestros objetivos
            empresariales. Estamos comprometidos con la formación y el
            desarrollo de nuestro equipo para garantizar nuestro éxito.
          </p>
        </div>
      </div>
      <div>
