            ...
            >
              <div>
                <div className="relative inline-flex flex-col mb-4">
                  ...
                  />
                  <svg
                    className="absolute top-0 right-0 -mr-3 w-6 h-5 fill-current text-cyan-600"
                    viewBox="0 0 24 20"
              ...
              <div className="text-gray-700 font-medium mt-6 pt-5 border-t border-gray-700">
                ...
                -{" "}
                <a
                  className="text-cyan-600 hover:text-gray-200 transition duration-150 ease-in-out"
                  href="#0"
                >
                  UX Board
                </a>
